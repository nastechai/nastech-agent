...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Nastech's web-provider config and
        ...
        # native search engine for xAI sessions instead of Nastech's
        # configured web provider (Tavily/etc.), and those results bypass
        # Nastech's tool-trace / citation plumbing (they arrive baked into the
