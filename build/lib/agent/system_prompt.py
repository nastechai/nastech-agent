...
def _ra():
    ...
    ``build_context_files_prompt``, ``build_nastechai_subscription_prompt``,
...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    nastechai_subscription_prompt = _r.build_nastechai_subscription_prompt(agent.valid_tool_names)
    if nastechai_subscription_prompt:
        stable_parts.append(nastechai_subscription_prompt)
