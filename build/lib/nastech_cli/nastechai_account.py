...
class NastechaiPortalAccountInfo:
    ...
    nastechai_client: Optional[str] = None
...
def nastechai_portal_topup_url(account_info: Optional[NastechaiPortalAccountInfo] = None) -> str:
    ...
    """
    base_billing = nastechai_portal_billing_url(account_info)  # {base}/billing
...
def format_nastechai_portal_entitlement_message(
    ...
    *,
    ...
    """
    billing_url = nastechai_portal_billing_url(account_info)
...
def _info_from_valid_jwt(
    ...
    *,
    ...
    return NastechaiPortalAccountInfo(
        ...
        nastechai_client=_coerce_str(claims.get("nastechai_client")),
        portal_base_url=portal_base_url,
