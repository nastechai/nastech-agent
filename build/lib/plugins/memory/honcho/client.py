...
def resolve_active_host() -> str:
    ...
    Resolution order:
      ...
      2. Active profile name via profiles system -> ``nastech.<profile>``
      3. Fallback: ``"nastech"`` (default profile)
    """
...
class HonchoClientConfig:
    ...
    # Max chars of dialectic result to inject into Nastech system prompt
...
def get_honcho_client(config: HonchoClientConfig | None = None) -> Honcho:
    ...
    def _build() -> "Honcho":
        ...
        # the "go run nastech honcho setup" hint they used to.
        try:
