...
`NasTech Research/gateway-gateway`). The connector implementer's first action is to
read this file.
...
(`NasTech Research/gateway-gateway`); this section is the gateway-facing summary.
