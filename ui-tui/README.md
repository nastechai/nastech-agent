...
- `commands/billing.ts` — `/billing`: manage NasTechai remote spending — buy credits, auto-reload, limits
...
### Billing (`billing.ts`)
`/billing` — manage NasTechai remote spending — buy credits, auto-reload, limits
  ...
  src/
    ...
    app/
      ...
      slash/
        ...
        commands/
          billing.ts                /billing — manage NasTechai remote spending
