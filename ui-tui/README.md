...
- `commands/billing.ts` — `/billing`: manage Nastechai terminal billing — buy credits, auto-reload, limits
...
### Billing (`billing.ts`)
`/billing` — manage Nastechai terminal billing — buy credits, auto-reload, limits
...
### Credits (`credits.ts`)
`/credits` — Nastechai credit balance and browser top-up
  ...
  src/
    ...
    app/
      ...
      slash/
        ...
        commands/
          billing.ts                /billing — manage Nastechai terminal billing
