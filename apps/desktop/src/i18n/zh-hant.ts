...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        '遠端主機上未安裝 Nastech。請在遠端安裝（curl -fsSL https://nastech-agent.nastechai.com/install.sh | sh）或設定 Nastech 路徑。',
    ...
    toolsets: {
      ...
      nastechaiAuthNeededTitle: '登入 Nastechai Portal',
      nastechaiAuthNeededMessage: provider => `已儲存 ${provider}，但在登入 Nastechai Portal 之前不會啟用。`,
      nastechaiAuthSignIn: '登入',
      nastechaiAuthDoneTitle: '已連接 Nastechai Portal',
      nastechaiAuthDoneMessage: '訂閱後端現已啟用。',
      nastechaiAuthFailed: 'Nastechai Portal 登入未完成',
  ...
  commandCenter: {
    ...
    nastechaiage: period => `最近 ${period} 天暫無使用量。`,
    retry: '重試',
    dailyTokens: '每日詞元',
    input: '輸入',
    output: '輸出',
