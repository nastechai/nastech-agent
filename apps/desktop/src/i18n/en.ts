...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'Starting Nastech Desktop…'
    },
    errors: {
  ...
  settings: {
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Nastech writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
