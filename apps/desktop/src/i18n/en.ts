...
export const en: Translations = {
  ...
  billingBlock: {
    titleNasTechai: 'Out of NasTechai credits',
  ...
  settings: {
    ...
    toolsets: {
      ...
      nousIncluded: 'Included with a NasTechai subscription — sign in to NasTechai Portal to activate.',
      nousAuthNeededTitle: 'Sign in to NasTechai Portal',
      nousAuthNeededMessage: provider => `${provider} is saved but won't activate until you sign in to NasTechai Portal.`,
      nousAuthSignIn: 'Sign in',
      nousAuthDoneTitle: 'NasTechai Portal connected',
      nousAuthDoneMessage: 'Your subscription backends are now active.',
      nousAuthFailed: 'NasTechai Portal sign-in did not complete',
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid NasTechai subscription.',
    free: 'Free',
    freeTier: 'Free tier',
