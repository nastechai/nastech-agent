...
export const zh: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteTitle: '远程网关',
      remoteDesc:
        '将此桌面外壳连接到远程 Nastech 后端。托管网关使用 OAuth 或用户名密码；自托管网关也可能使用会话 token。',
      ...
      savedTitle: '网关设置已保存',
      restartingMessage: 'Nastech Desktop 将使用已保存设置重新连接。',
  ...
  onboarding: {
    ...
    flowSubtitles: {
      ...
      loopback: '打开浏览器登录 — Nastech 会自动连接',
