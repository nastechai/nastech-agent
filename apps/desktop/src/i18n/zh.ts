...
export const zh: Translations = {
  ...
  settings: {
    ...
    toolsets: {
      ...
      useBackend: '使用此后端',
      nousIncluded: '包含在 NasTechai 订阅中；登录 NasTechai Portal 即可激活。',
      nousAuthNeededTitle: '登录 NasTechai Portal',
      nousAuthNeededMessage: provider => `已保存 ${provider}，但在登录 NasTechai Portal 之前不会激活。`,
      nousAuthSignIn: '登录',
      nousAuthDoneTitle: '已连接 NasTechai Portal',
      nousAuthDoneMessage: '订阅后端现已激活。',
      nousAuthFailed: 'NasTechai Portal 登录未完成',
