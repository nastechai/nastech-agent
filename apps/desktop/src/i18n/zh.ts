...
export const zh: Translations = {
  ...
  billingBlock: {
    titlenastechai: 'nastechai 额度已用尽',
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        '远程主机上未安装 Nastech。请在远程安装（curl -fsSL https://nastech-agent.nastechai.com/install.sh | sh）或设置 Nastech 路径。',
    ...
    toolsets: {
      ...
      useBackend: '使用此后端',
      nastechaiIncluded: '包含在 nastechai 订阅中；登录 Nastechai Portal 即可激活。',
      nastechaiAuthNeededTitle: '登录 Nastechai Portal',
      nastechaiAuthNeededMessage: provider => `已保存 ${provider}，但在登录 Nastechai Portal 之前不会激活。`,
      nastechaiAuthSignIn: '登录',
      nastechaiAuthDoneTitle: '已连接 Nastechai Portal',
      nastechaiAuthDoneMessage: '订阅后端现已激活。',
      nastechaiAuthFailed: 'Nastechai Portal 登录未完成',
  ...
  commandCenter: {
    ...
    loadingUsage: '正在加载用量…',
    nastechaiage: period => `最近 ${period} 天暂无用量。`,
    retry: '重试',
    dailyTokens: '每日词元',
    input: '输入',
    output: '输出',
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro 模型需要付费 nastechai 订阅。',
    free: '免费',
    freeTier: '免费层',
