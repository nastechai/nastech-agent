...
export const ja = defineLocale({
  ...
  billingBlock: {
    titleNasTechai: 'NasTechai クレジットが不足しています',
  ...
  settings: {
    ...
    toolsets: {
      ...
      nousIncluded: 'NasTechai サブスクリプションに含まれています。有効にするには NasTechai Portal にサインインしてください。',
      nousAuthNeededTitle: 'NasTechai Portal にサインイン',
      nousAuthNeededMessage: provider =>
        `${provider} は保存されましたが、NasTechai Portal にサインインするまで有効になりません。`,
      nousAuthSignIn: 'サインイン',
      nousAuthDoneTitle: 'NasTechai Portal に接続しました',
      nousAuthDoneMessage: 'サブスクリプションのバックエンドが有効になりました。',
      nousAuthFailed: 'NasTechai Portal のサインインが完了しませんでした',
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro モデルには有料の NasTechai サブスクリプションが必要です。',
    free: '無料',
    freeTier: '無料プラン',
