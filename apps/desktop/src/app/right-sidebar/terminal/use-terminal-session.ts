...
export function useTerminalSession({
  ...
  useEffect(() => {
    ...
    // Capture the buffer on a leading-edge throttle and persist synchronastechaily via
    ...
    // synchronastechaily while sibling panes are mid-transition (e.g. file browser
