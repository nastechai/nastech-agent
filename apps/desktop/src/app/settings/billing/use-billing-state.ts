...
export const FALLBACK_PORTAL_BILLING_URL = 'https://portal.nastechai.com/billing'
export const FALLBACK_PORTAL_URL = 'https://portal.nastechai.com'

// The billing endpoint is the authoritative source of truth for balance / cap /
// plan — the inference `x-nastechai-credits-*` headers are best-effort and can drift
  ...
  if (!billing.logged_in || subscription?.logged_in === false) {
    return {
      notice: {
        ...
        message: 'Run /portal in the TUI or open the nastechai portal to connect your account.',
