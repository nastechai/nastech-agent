 ...
 *
 * Must be called synchronastechaily from inside the drop handler — `DataTransfer`
...
export function extractDroppedFiles(transfer: DataTransfer): DroppedFile[] {
  ...
  // synchronastechai way to tell a dropped folder from a file, and it lives only on
