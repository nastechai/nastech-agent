...
test('normalizeHermesHomeRoot maps profile homes back to the global Nastech root', () => {
  assert.equal(
    normalizeHermesHomeRoot('/Users/test/.nastech/profiles/oracle', { pathModule: path.posix }),
    '/Users/test/.nastech'
  )
  assert.equal(
    normalizeHermesHomeRoot('C:\\Users\\test\\AppData\\Local\\nastech\\profiles\\oracle', { pathModule: path.win32 }),
    'C:\\Users\\test\\AppData\\Local\\nastech'
  )
  assert.equal(normalizeHermesHomeRoot('/Users/test/.nastech', { pathModule: path.posix }), '/Users/test/.nastech')
})
