 ...
 * origin=git@github.com:nastechaiResearch/nastech-agent.git. A background
...
test('canonicalGitHubRemote normalizes SSH and HTTPS forms to the same value', () => {
  ...
  assert.equal(
    canonicalGitHubRemote('ssh://git@github.com/nastechaiResearch/nastech-agent.git'),
    OFFICIAL_REPO_CANONICAL
  )
  ...
  assert.equal(canonicalGitHubRemote('https://github.com/nastechaiResearch/nastech-agent/'), OFFICIAL_REPO_CANONICAL)
})
...
test('isOfficialSshRemote is true only for the official repo over SSH', () => {
  ...
  assert.equal(isOfficialSshRemote('git@github.com:nastechaiResearch/nastech-agent'), true)
  assert.equal(isOfficialSshRemote('ssh://git@github.com/nastechaiResearch/nastech-agent.git'), true)
