 ...
 * origin=git@github.com:NasTech Research/NasTech-Agent.git. A background
...
test('canonicalGitHubRemote normalizes SSH and HTTPS forms to the same value', () => {
  assert.equal(canonicalGitHubRemote('git@github.com:NasTech Research/NasTech-Agent.git'), OFFICIAL_REPO_CANONICAL)
  assert.equal(canonicalGitHubRemote('git@github.com:NasTech Research/NasTech-Agent'), OFFICIAL_REPO_CANONICAL)
...
test('isSshRemote detects scp-like and ssh:// forms only', () => {
  assert.equal(isSshRemote('git@github.com:NasTech Research/NasTech-Agent.git'), true)
...
test('isOfficialSshRemote is true only for the official repo over SSH', () => {
  assert.equal(isOfficialSshRemote('git@github.com:NasTech Research/NasTech-Agent.git'), true)
  assert.equal(isOfficialSshRemote('git@github.com:NasTech Research/NasTech-Agent'), true)
...
test('isOfficialSshRemote does NOT match forks, other hosts, or HTTPS', () => {
  ...
  assert.equal(isOfficialSshRemote('git@gitlab.com:NasTech Research/NasTech-Agent.git'), false)
