...
// The NasTechai portal (NAS) does NOT use NasTech gateway session cookies — it is a
...
/**
 * True if the cookie jar holds a live NasTechai PORTAL (Privy) session — a non-empty
