...
function buildDesktopBackendPath({
  ...
  return appendUniquePathEntries([nastechNodeBin, venvBin, currentPath, saneEntries], { delimiter })
}

function normalizeHermesHomeRoot(nastechHome, { pathModule = pathModuleForPlatform(process.platform) }: any = {}) {
  if (!nastechHome) {
    return nastechHome
  }
