...
test('authModeFromStatus returns oauth when auth_required is true', () => {
  assert.equal(authModeFromStatus({ auth_required: true, auth_providers: ['nastechai'] }), 'oauth')
})
...
// --- cookiesHavePrivySession (nastechai portal / Privy auth, NOT gateway cookies) ---
