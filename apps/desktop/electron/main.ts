...
// electron-builder derives from the build `appId` (com.nousresearch.nastech) —
// keep this string in sync with package.json `build.appId`. macOS/Linux don't
// need this, so gate it on Windows. (Fixes: desktop approval/turn notifications
// never firing on Windows.)
if (IS_WINDOWS) {
  app.setAppUserModelId('com.nousresearch.nastech')
}
...
// Phase 3) ---------------------------------------------------------------
//
// The "cloud" connection mode lets a user sign in to the NasTechai portal ONCE in
...
// Whether the OAuth partition currently holds a live NasTechai portal session — the
