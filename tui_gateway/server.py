...
class _SlashWorker:
    ...
    def __init__(self, session_key: str, model: str, profile_home: str | None = None):
        ...
        if profile_home:
            ...
            # gateway's launch NASTECH_HOME (#40677).
...
def _load_dashboard_process_isolation_config(cfg: dict | None = None) -> dict[str, Any]:
    ...
    overlay; it does not deep-merge ``nastech_cli.config.DEFAULT_CONFIG``. Keep
...
def _load_approval_mode() -> str:
    from nastech_cli.config import DEFAULT_CONFIG, _deep_merge
    ...
    if key == "model":
        try:
            ...
            if session:
                ...
                from nastech_cli.model_switch import parse_model_flags_detailed
...
def _is_session_cwd_junk(cwd: str) -> bool:
    ...
    return real == home or real == nastech_home
