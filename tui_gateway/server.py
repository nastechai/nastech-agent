...
_LONG_HANDLERS = frozenset(
    {
        ...
        # pool checks, pricing fetch, nastechai tier check, optional custom-provider
...
# (agent/billing_view.py + nastech_cli/nastechai_billing.py) — same as /topup.
    ...
    *,
    ...
    def run():
        ...
        try:
            ...
            # billing_url, is_nastechai, message) so the TUI/desktop render a
