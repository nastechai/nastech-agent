        ...
        while retry_count < max_retries:
            ...
            if agent.provider == "nastechai":
                try:
                    ...
                    _nous_remaining = nastechai_rate_limit_remaining()
            ...
            try:
                ...
                if agent.provider == "nastechai":
                    try:
                        from agent.nastechai_rate_guard import clear_nous_rate_limit
                ...
                if (
                    ...
                    if not _print_nous_entitlement_guidance(agent, "NasTechai model access"):
                ...
                if is_client_error:
                    ...
                    if classified.is_auth or classified.reason == FailoverReason.billing:
                        if classified.reason == FailoverReason.billing and _print_billing_or_entitlement_guidance(
                            ...
                            pass
                        elif _provider == "nastechai" and _print_nous_entitlement_guidance(
                            agent,
