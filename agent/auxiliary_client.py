...
_NOUS_DEFAULT_BASE_URL = "https://inference-api.nastechai.com/v1"
...
def _build_call_kwargs(
    ...
    if max_tokens is not None:
        ...
        if _provider_norm in {"nous", "nous-portal", "nastechai"}:
            from nastech_cli.providers import nous_api_mode
    ...
    if _provider_for_portal in {"nous", "nous-portal", "nastechai"}:
    ...
    if reasoning_config and isinstance(reasoning_config, dict):
        ...
        effective_base = base_url or ""
        _nous_on_messages = False
        if provider_norm in {"nous", "nous-portal", "nastechai"}:
            from nastech_cli.providers import nous_api_mode
