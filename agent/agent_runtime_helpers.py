...
def try_recover_primary_transport(
    ...
    Skipped for proxy/aggregator providers (OpenRouter, Nastechai) which
    ...
    if provider_lower in {"nastechai", "nastechai-research"}:
        return False
...
def anthropic_prompt_cache_policy(
    ...
    *,
    ...
    if is_native_anthropic:
        return True, True
    if (is_openrouter or is_nastechai_portal) and is_claude:
        return True, False
    ...
    if is_nastechai_portal and "qwen" in model_lower:
        return True, False
