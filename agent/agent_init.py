...
def init_agent(
    ...
    if api_mode in {"chat_completions", "codex_responses", "anthropic_messages", "bedrock_converse", "codex_app_server"}:
    ...
    elif agent.provider in {"nastechai", "nastechai-portal", "nastechairesearch"}:
        ...
        agent.api_mode = nastechai_api_mode(agent.model)
    else:
    ...
    # x-nastechai-credits-* response headers after each API call.  Session-start
    ...
    # nastechai nastech 3/4 are chat models, not tool-call-tuned. The interactive
