...
def run_curator_review(
    ...
    If *synchronastechai* is True, the LLM review runs in the calling thread; the
...
def _run_llm_review(prompt: str) -> Dict[str, Any]:
    ...
    try:
        ...
        # run_curator_review(synchronastechai=True) from the CLI.
