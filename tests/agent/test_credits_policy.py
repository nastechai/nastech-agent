...
class TestIsFreeTierModel:
    ...
    def test_pricing_cache_peek_zero_priced_model(self, monkeypatch):
        ...
        monkeypatch.setattr(
            ...
            "_pricing_cache",
            {
                "https://inference-api.nastechai.com": {
        ...
        base = "https://inference-api.nastechai.com/v1"
        ...
        assert is_free_tier_model("some/zero-priced", "https://inference-api.nastechai.com/") is True
        assert is_free_tier_model("some/zero-priced", "https://inference-api.nastechai.com/v1/") is True
    ...
    def test_exception_fails_open_to_false(self, monkeypatch):
        ...
        assert is_free_tier_model("some/model", "https://inference-api.nastechai.com") is False
