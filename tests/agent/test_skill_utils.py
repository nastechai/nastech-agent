...
def test_metadata_as_dict_with_nastech():
    """Normal case: metadata is a dict containing nastech keys."""
    frontmatter = {
        "metadata": {
            "nastech": {
...
class TestParseFrontmatterBOM:
    ...
    def test_bom_config_vars_preserved(self):
        # metadata.nastech.config drives secure setup-on-load; it must survive
