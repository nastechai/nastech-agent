...
class TestRecordNasTechaiRateLimit:
    ...
    def test_records_with_header_reset(self, rate_guard_env):
        from agent.nastechai_rate_guard import record_nous_rate_limit, _state_path
...
class TestNasTechaiRateLimitRemaining:
    ...
    def test_returns_remaining_seconds_when_active(self, rate_guard_env):
        from agent.nastechai_rate_guard import record_nous_rate_limit, nastechai_rate_limit_remaining
...
class TestAuxiliaryClientIntegration:
    ...
    def test_try_nous_skips_when_rate_limited(self, rate_guard_env, monkeypatch):
        from agent.nastechai_rate_guard import record_nous_rate_limit
...
class TestIsGenuineNasTechaiRateLimit:
    ...
    def test_exhausted_hourly_bucket_in_429_headers_is_genuine(self):
        from agent.nastechai_rate_guard import is_genuine_nous_rate_limit
