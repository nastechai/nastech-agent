...
class TestKimiFamilyGetsAdaptiveThinking:
    ...
    def test_kimi_effort_mapping(self, nastech_effort: str, wire_effort: str) -> None:
        from agent.anthropic_adapter import build_anthropic_kwargs
        ...
        kwargs = build_anthropic_kwargs(
            ...
            tools=None,
            max_tokens=4096,
            reasoning_config={"enabled": True, "effort": nastech_effort},
