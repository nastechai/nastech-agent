...
class TestModuleSurface:
    ...
    def test_expected_nastech_specific_tools_listed(self):
        """The Nastech-specific tools should be present so users on the
    ...
    def test_kanban_worker_tools_exposed(self):
        """Kanban workers run as `nastech chat -q` subprocesses; if they
