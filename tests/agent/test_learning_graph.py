...
def test_nastech_meta_tolerates_non_dict():
    assert learning_graph._nastech_meta({"metadata": "junk"}) == {}
    assert learning_graph._nastech_meta({"metadata": {"nastech": "junk"}}) == {}
    assert learning_graph._nastech_meta({"metadata": {"nastech": {"category": "x"}}}) == {"category": "x"}
