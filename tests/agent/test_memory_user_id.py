...
class TestMem0UserIdScoping:
    ...
    def test_no_user_id_no_config_uses_nastech_user(self):
        """Without user_id or config override, should default to 'nastech-user'."""
        from plugins.memory.mem0 import Mem0MemoryProvider
        ...
        assert provider._user_id == "nastech-user"
