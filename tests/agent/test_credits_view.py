...
from nastech_cli.nous_account import NousPortalAccountInfo, NousPaidServiceAccessInfo
...
def test_view_fetch_failure_is_logged_out(monkeypatch):
    ...
    monkeypatch.setattr("nastech_cli.nous_account.get_nous_portal_account_info", _boom)
