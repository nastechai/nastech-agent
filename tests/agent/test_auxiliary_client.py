...
class TestBuildCallKwargsMaxTokens:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("nous", "nastech-4", "https://inference-api.nastechai.com/v1", "max_tokens"),
        ],
    )
...
class TestAuxiliaryPoolAwareness:
    ...
    def test_call_llm_retries_nous_after_401(self):
        ...
        with (
            ...
            patch("agent.auxiliary_client._resolve_nous_runtime_api", return_value=("fresh-agent-key", "https://inference-api.nastechai.com/v1")),
        ):
            result = call_llm(
                task="compression",
                messages=[{"role": "user", "content": "hi"}],
