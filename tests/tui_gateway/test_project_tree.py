...
def test_junk_root_is_dropped_from_the_discovered_tier():
    discovered = [{"root": "/home/me/.nastech", "label": ".nastech", "sessions": 0, "last_active": 9}]

    tree = pt.build_tree([], [], discovered, resolve=None, is_junk_root=lambda r: r == "/home/me/.nastech")
...
def test_non_git_cwd_can_group_inside_a_junk_repo_subtree():
    ...
    workspace = _session("/home/test/.nastech/workspaces/notes")
    ...
    tree = pt.build_tree(
        ...
        hydrate=True,
        is_junk_root=lambda path: path.startswith("/home/test/.nastech"),
        is_junk_cwd=lambda path: path in {"/home/test", "/home/test/.nastech"},
    )

    assert [p["id"] for p in tree["projects"]] == ["/home/test/.nastech/workspaces/notes"]
