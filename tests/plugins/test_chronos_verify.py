...
AUD = "agent:inst-123"
ISS = "https://portal.nastechai.com"
...
def test_jwks_url_path_resolves_key(rsa_keys, monkeypatch):
    ...
    class FakeJWKClient:
        def __init__(self, url, **kwargs):
            assert url == "https://portal.nastechai.com/.well-known/jwks.json"
    ...
    claims = verify_nas_fire_token(
        ...
        jwks_or_key="https://portal.nastechai.com/.well-known/jwks.json",
        issuer=ISS,
    )
...
def test_jwks_client_sends_explicit_http_headers(monkeypatch):
    ...
    url = "https://portal.nastechai.com/.well-known/jwks.json"
