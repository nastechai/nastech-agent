...
class TestAggregatorProviders:
    ...
    def test_nastechai_prepends_vendor(self):
        result = normalize_model_for_provider("gpt-5.4", "nastechai")
...
class TestDeepseekVSeriesPassThrough:
    ...
    aggregators (Nastechai portal, OpenRouter via DeepInfra) routes to V3 —
