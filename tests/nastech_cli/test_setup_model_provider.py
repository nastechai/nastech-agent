...
def test_setup_summary_marks_anthropic_auth_as_vision_available(tmp_path, monkeypatch, capsys):
    ...
    assert "missing run 'nastech setup' to configure" not in output
    ...
    monkeypatch.setattr(
        ...
        lambda config: NastechaiSubscriptionFeatures(
            ...
            features={
                ...
                "browser": NastechaiFeatureState("browser", "Browser automation", True, True, True, False, True, True, "Camofox"),
                "modal": NastechaiFeatureState("modal", "Modal execution", False, False, False, False, False, True, "local"),
            },
        ),
    )
    monkeypatch.setattr("agent.auxiliary_client.get_available_vision_backends", lambda: [])
    ...
    monkeypatch.setattr(
        ...
        lambda config: NastechaiSubscriptionFeatures(
            ...
            features={
                ...
                "video_gen": NastechaiFeatureState("video_gen", "Video generation", False, False, False, False, False, False, ""),
                "tts": NastechaiFeatureState("tts", "OpenAI TTS", True, False, False, False, False, True, ""),
                "browser": NastechaiFeatureState("browser", "Browser automation", True, False, False, False, False, True, "Browserbase"),
                "modal": NastechaiFeatureState("modal", "Modal execution", False, False, False, False, False, True, "local"),
            },
        ),
    )
...
def test_setup_summary_local_browser_unavailable_without_chromium(
    ...
    ``get_nastechai_subscription_features`` so the surface stays aligned with the
    ...
    monkeypatch.setattr("nastech_cli.nastechai_subscription._has_agent_browser", lambda: True)
    monkeypatch.setattr(
