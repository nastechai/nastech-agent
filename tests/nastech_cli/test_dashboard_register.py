...
class TestHappyPath:
    def _run(self, *, args, account_token="tok_abc", portal="https://portal.nastechai.com",
...
class TestPublicUrlPersistence:
    ...
    def _run(self, *, args, existing_public=None):
        ...
        with patch(
            ...
            dr, "_resolve_portal_base_url", return_value="https://portal.nastechai.com"
        ), patch(
            "nastech_cli.config.get_env_value", side_effect=fake_get_env_value
        ), patch(
            "nastech_cli.config.save_env_value", side_effect=fake_save
...
class TestPortalResolution:
    ...
    def test_falls_back_to_stored_login_portal(self):
        with patch(
            ...
            return_value={"portal_base_url": "https://portal.staging-nastechai.com"},
        ):
            assert (
                dr._resolve_portal_base_url(None)
                == "https://portal.staging-nastechai.com"
            )
...
class TestPortalErrors:
    def _run_http_error(self, code, body):
        err = urllib.error.HTTPError(
            url="https://portal.nastechai.com/api/oauth/self-hosted-client",
            code=code,
            msg="err",
            hdrs=None,
