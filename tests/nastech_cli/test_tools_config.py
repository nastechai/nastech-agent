...
def test_first_install_nous_auto_configures_video_gen(monkeypatch):
    ...
    monkeypatch.setattr("nastech_cli.nastechai_subscription.managed_nous_tools_enabled", lambda: True)
    config = {
    ...
    monkeypatch.setattr(
        "nastech_cli.nastechai_subscription.get_nous_portal_account_info",
