...
1. _lifespan fire-and-forget: patched _warm_gateway_module sleeps N seconds in
   ...
   blocked, NASTECH_DASHBOARD_READY would fire immediately).
...
def test_lifespan_warmup_is_nonblocking():
    ...
    NASTECH_DASHBOARD_READY would have fired without delay.
    """
    ...
    # If the import were synchronastechai, startup would block for >= SLOW_SECONDS.
