"""Tests for the nastech_cli.nous_billing HTTP client's response handling.
...
from nastech_cli import nous_billing as nb
...
def test_403_cli_billing_disabled_stays_generic_with_portal_url(monkeypatch):
    ...
    assert ei.value.portal_url == "https://portal.nastechairesearch.com/billing"
