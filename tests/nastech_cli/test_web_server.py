...
class TestWebServerEndpoints:
    ...
    def test_update_nastech_returns_docker_guidance_without_spawning(self, monkeypatch):
        ...
        assert "docker pull nousresearch/nastech-agent:latest" in data["message"]
        ...
        assert any("docker pull nousresearch/nastech-agent:latest" in line for line in status_data["lines"])
...
class TestNewEndpoints:
    ...
    def test_select_managed_nous_provider_reports_needs_nous_auth(self, monkeypatch):
        """Selecting a managed NasTechai row while logged out flags needs_nous_auth.
