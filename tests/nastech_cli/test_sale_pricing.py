...
def test_resolve_nastechai_pricing_credentials_honors_inference_env_override(monkeypatch):
    """Staging profiles set nastechai_INFERENCE_BASE_URL — pricing must follow it.
