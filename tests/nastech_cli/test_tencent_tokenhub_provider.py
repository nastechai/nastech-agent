...
class TestTencentInOpenRouterAndNastechai:
    """tencent/hy3-preview:free and tencent/hy3-preview should appear in OpenRouter and Nastechai curated lists."""
    ...
    def test_in_nastechai_provider_models(self):
        from nastech_cli.models import _PROVIDER_MODELS
        assert "tencent/hy3-preview" in _PROVIDER_MODELS["nastechai"]
...
class TestTencentTokenhubDoctor:
    """Verify nastech doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``nastech model`` routes it through the generic api_key_provider flow.
        """
        import inspect
