...
class TestBashSafePath:
    ...
    def test_forward_slash_native_path_becomes_msys(self, monkeypatch):
        ...
        monkeypatch.setattr(local_mod, "_IS_WINDOWS", True)
        assert (
            _bash_safe_path("C:/Users/Alexander/.nastech/cache/terminal/nastech-snap-x.sh")
            == "/c/Users/Alexander/.nastech/cache/terminal/nastech-snap-x.sh"
        )
...
class TestWindowsMsysPathconvDefaults:
    ...
    def test_nastech_subprocess_env_sets_msys_no_pathconv_on_windows(self, monkeypatch):
        monkeypatch.setattr(local_mod, "_IS_WINDOWS", True)
    ...
    def test_msys2_arg_conv_excl_set_on_windows(self, monkeypatch):
        ...
        assert nastech_subprocess_env().get("MSYS2_ARG_CONV_EXCL") == "*"
...
class TestWrapCommandWindowsNativeCwd:
    ...
    def test_init_session_bootstrap_quotes_snapshot_paths_in_msys_form(self, monkeypatch):
        ...
        snap = "C:/Users/Alexander/.nastech/cache/terminal/nastech-snap-deadbeef.sh"
        ...
        assert "/c/Users/Alexander/.nastech/cache/terminal/nastech-snap-deadbeef.sh" in script
