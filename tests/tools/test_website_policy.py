...
def test_check_website_access_uses_dynamic_nastech_home(monkeypatch, tmp_path):
    ...
    # Invalidate the module-level cache so the new NASTECH_HOME is picked up.
    # A prior test may have cached a default policy (enabled=False) under the
    # old NASTECH_HOME set by the autouse _isolate_nastech_home fixture.
