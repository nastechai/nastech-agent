...
# Keys allowed to be persisted for a session's /model override. api_key and
# api_mode are intentionally excluded — credentials are never written to
# sessions.json and are re-resolved via the normal runtime provider
# resolution when the override is rehydrated after a gateway restart.
    ...
    def _save(self) -> None:
        ...
        data = {
            "_README": (
                ...
                "~/.nastech/state.db and are shown by `nastech sessions list` and "
    ...
    def get_or_create_session(
        ...
        with self._lock:
            ...
            if session_key in self._entries and not force_new:
                ...
                # (nastech_state.find_latest_gateway_session_for_peer) selects
