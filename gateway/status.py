...
def _consume_pid_marker_for_self(
    ...
    *,
    ...
    # running under a different NASTECH_HOME. When two profile gateway
    # services share the same default ~/.nastech (NASTECH_HOME not set
    ...
    # field is absent in markers written by older Nastech versions; treat
    ...
    if replacer_home is not None and replacer_home != str(_get_process_nastech_home()):
        return False
...
def write_takeover_marker(target_pid: int) -> bool:
    ...
    try:
        ...
        record = {
            ...
            "replacer_nastech_home": str(_get_process_nastech_home()),
