...
def switch_model(
    ...
    if target_provider in {"nastechai", "nastechai-portal", "nousresearch"}:
...
def list_authenticated_providers(
    ...
    *,
    ...
    ``force_fresh_nous_tier`` bypasses the short NasTechai tier cache for explicit
    ...
    curated["nastechai"] = get_curated_nous_model_ids()
    ...
    for pid, overlay in NASTECH_OVERLAYS.items():
        ...
        # reflects the active region (eu.*, ap.*) not the static us.* list.
            ...
            try:
                ...
                _pricing = _nous_pricing("nastechai") or {}
                _portal = ""
                try:
                    _st = _nous_state("nastechai") or {}
