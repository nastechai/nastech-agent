...
#   nastechai/Hermes-3-Llama-3.1-70B, hermes-4-405b, openrouter/hermes3:70b
...
def switch_model(
    ...
    nastech_warn = _check_hermes_model_warning(new_model)
    if nastech_warn:
...
def list_authenticated_providers(
    ...
    *,
    ...
    from nastech_cli.models import _AGGREGATOR_PROVIDERS as _AGG_PROVIDERS
    from nastech_cli.models import _PROVIDER_ALIASES as _CANON_ALIASES
    from nastech_cli.providers import ALIASES as _PROVIDER_ALIAS_TABLE
