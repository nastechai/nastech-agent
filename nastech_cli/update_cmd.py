...
def _update_via_zip(args):
    ...
    try:
        ...
        print(
            ...
            "reinstall from https://NasTech-Agent.nastechai.com"
        )
        _m().sys.exit(1)
    finally:
...
OFFICIAL_REPO_URLS = {
    ...
    "git@github.com:NasTech Research/NasTech-Agent.git",
    "https://github.com/nastechai/NasTech-Agent",
    "git@github.com:NasTech Research/NasTech-Agent",
}
...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from NasTech Research/NasTech-Agent.")
        print()
        try:
            response = (
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        if not import_ok:
            ...
            print("    https://NasTech-Agent.nastechai.com")
