...
def main():
    ...
    secrets_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://nastech-agent.nastechai.com/docs/user-guide/secrets/"
        ),
    )
    ...
    egress_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://nastech-agent.nastechai.com/docs/user-guide/egress/iron-proxy"
        ),
    )
    ...
    def _add_session_filter_args(p, default_older_help):
        ...
        p.add_argument(
            ...
            "(e.g. openrouter, anthropic, nastechai)",
        )
        p.add_argument(
