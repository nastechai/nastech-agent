...
def _count_status_active_sessions() -> int:
    ...
    while another NasTech process is writing to it.
    """
    from nastech_state import DEFAULT_DB_PATH, SessionDB
...
def _open_session_db_for_profile(profile: Optional[str], *, read_only: bool):
    ...
    from nastech_state import SessionDB, _default_db_path, is_malformed_db_error
