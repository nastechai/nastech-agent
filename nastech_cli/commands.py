...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("subscription", "View your nastechai plan and change it in the browser", "Info",
               cli_only=True, aliases=("upgrade",)),
    CommandDef("topup", "Show your nastechai balance and manage billing on the portal", "Info"),
...
#     native slash.
_SLACK_VIA_NASTECH_ONLY = frozenset({"topup", "moa", "debug", "egress", "init", "version", "diff", "update", "heartbeat", "refine"})
