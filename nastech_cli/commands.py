...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("compress", "Compress conversation context (add 'here [N]' to keep recent N turns)", "Session",
               aliases=("compact",), args_hint="[here [N] | focus topic] [--preview|--dry-run] [--aggressive]"),
    ...
    CommandDef("credits", "Show Nastechai credit balance and top up", "Info"),
    CommandDef("billing", "Manage Nastechai terminal billing — buy credits, auto-reload, limits", "Info",
               cli_only=True),
...
#   - credits: the billing/top-up surface; reached via /nastech credits on Slack.
#   - billing: the terminal-billing surface (buy/auto-reload/limit); /nastech billing.
...
_SLACK_VIA_NASTECH_ONLY = frozenset({"credits", "billing", "moa", "debug"})
