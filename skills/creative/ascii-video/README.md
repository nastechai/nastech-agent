...
Built for [Nastech Agent](https://github.com/NastechaiResearch/nastech-agent). Usable in any coding agent. Canonical source lives here; synced to [`NastechaiResearch/nastech-agent/skills/creative/ascii-video`](https://github.com/NastechaiResearch/nastech-agent/tree/main/skills/creative/ascii-video) via PR.
