...
Built for [Nastech Agent](https://github.com/nastechai/nastech-agent). Usable in any coding agent. Canonical source lives here; synced to [`nastechairesearch/nastech-agent/skills/creative/ascii-video`](https://github.com/nastechai/nastech-agent/tree/main/skills/creative/ascii-video) via PR.
