/**
 * NasTech desktop plugin template. Save as:
 *   <nastech home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <nastech home> is ~/.nastech by default, or ~/.nastech/profiles/<name>
 * when running a named profile (`nastech -p <name>`). Run `nastech doctor` (or
 ...
 * Only these imports resolve: @nastech/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@nastech/plugin-sdk'
