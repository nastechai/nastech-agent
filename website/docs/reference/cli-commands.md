...
| `--nastechai` | Upload to nastechai-internal diagnostics storage instead of a public paste service. Use this when nastechai support asks for a private diagnostic bundle. |
...
Default uploads use public paste services tried in order: paste.rs, dpaste.com. `--nastechai` uploads the same debug bundle to private nastechai diagnostics storage instead; the returned viewer link is for the nastechai team and auto-deletes after 14 days.
...
nastech debug share --nastechai       # Upload a private diagnostics bundle for nastechai support
