...
| `/hatch <description>` (alias: `/generate-pet`) | Generate a brand-new petdex pet from a text description, using the configured image backend (OpenRouter / Nastechai Portal). See [Pets](/user-guide/features/pets). |
...
| `/credits` | Show your Nastechai credit balance and a top-up handoff link. |
| `/billing` | CLI terminal-billing flow for Nastechai — view balance, buy credits, and manage auto-reload / monthly limits. |
...
| `/credits` | Show your Nastechai credit balance and a top-up link that opens the portal billing page in a browser. |
