...
The Portal's own [info page](https://portal.nastechai.com/info) carries this warning too — it's the official Nous guidance, not just a NasTech-side opinion.
