...
When the app opens, you'll see a "Let's get you set up" screen. Click **Nous Portal** (marked **Recommended**). Your browser opens — create a [Nous Portal](https://portal.nastechai.com) account (or sign in), choose the **Free** plan, and authorize NasTech. The app connects automatically.
...
In the browser, create a [Nous Portal](https://portal.nastechai.com) account (or sign in) and choose the **Free** plan.
