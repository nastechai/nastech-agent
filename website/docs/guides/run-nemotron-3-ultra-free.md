...
[Download the Nastech Desktop installer](https://nastech-agent.nastechai.com/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).

### 2. Connect Nastechai Portal

When the app opens, you'll see a "Let's get you set up" screen. Click **Nastechai Portal** (marked **Recommended**). Your browser opens — create a [Nastechai Portal](https://portal.nastechai.com) account (or sign in), choose the **Free** plan, and authorize Nastech. The app connects automatically.
...
Prefer to review first? Download [`install.sh`](https://nastech-agent.nastechai.com/install.sh), inspect it, then run it.
...
In the browser, create a [Nastechai Portal](https://portal.nastechai.com) account (or sign in) and choose the **Free** plan.
