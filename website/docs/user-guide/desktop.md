...
The rest of this section shows the username/password path because it's the quickest to stand up on a trusted network; for the OAuth path see [Web Dashboard → Default provider: NasTech Research](./features/web-dashboard.md#default-provider-nastechai).
...
`tccutil reset All com.nastechai.nastech` and re-grant.
