...
| Related skills | [`ascii-video`](/nastech-agent/docs/user-guide/skills/bundled/creative/creative-ascii-video), [`manim-video`](/nastech-agent/docs/user-guide/skills/bundled/creative/creative-manim-video), [`p5js`](/nastech-agent/docs/user-guide/skills/bundled/creative/creative-p5js), [`comfyui`](/nastech-agent/docs/user-guide/skills/bundled/creative/creative-comfyui), [`touchdesigner-mcp`](/nastech-agent/docs/user-guide/skills/bundled/creative/creative-touchdesigner-mcp), [`blender-mcp`](/nastech-agent/docs/user-guide/skills/optional/creative/creative-blender-mcp), [`pixel-art`](/nastech-agent/docs/user-guide/skills/optional/creative/creative-pixel-art), [`ascii-art`](/nastech-agent/docs/user-guide/skills/bundled/creative/creative-ascii-art), [`songwriting-and-ai-music`](/nastech-agent/docs/user-guide/skills/bundled/creative/creative-songwriting-and-ai-music), [`heartmula`](/nastech-agent/docs/user-guide/skills/optional/creative/creative-heartmula), [`songsee`](/nastech-agent/docs/user-guide/skills/bundled/media/media-songsee), [`youtube-content`](/nastech-agent/docs/user-guide/skills/bundled/media/media-youtube-content), [`claude-design`](/nastech-agent/docs/user-guide/skills/bundled/creative/creative-claude-design), [`excalidraw`](/nastech-agent/docs/user-guide/skills/bundled/creative/creative-excalidraw), [`architecture-diagram`](/nastech-agent/docs/user-guide/skills/bundled/creative/creative-architecture-diagram), [`concept-diagrams`](/nastech-agent/docs/user-guide/skills/optional/creative/creative-concept-diagrams), [`baoyu-comic`](/nastech-agent/docs/user-guide/skills/optional/creative/creative-baoyu-comic), [`baoyu-infographic`](/nastech-agent/docs/user-guide/skills/bundled/creative/creative-baoyu-infographic), [`humanizer`](/nastech-agent/docs/user-guide/skills/bundled/creative/creative-humanizer), [`gif-search`](/nastech-agent/docs/user-guide/skills/bundled/media/media-gif-search), [`meme-generation`](/nastech-agent/docs/user-guide/skills/optional/creative/creative-meme-generation) |
...
team-design JSON. See **[references/kanban-setup.md](https://github.com/nastechaiResearch/nastech-agent/blob/main/optional-skills/creative/kanban-video-orchestrator/references/kanban-setup.md)**
...
playbook, see **[references/monitoring.md](https://github.com/nastechaiResearch/nastech-agent/blob/main/optional-skills/creative/kanban-video-orchestrator/references/monitoring.md)**.
...
task graphs. See **[references/examples.md](https://github.com/nastechaiResearch/nastech-agent/blob/main/optional-skills/creative/kanban-video-orchestrator/references/examples.md)**.
