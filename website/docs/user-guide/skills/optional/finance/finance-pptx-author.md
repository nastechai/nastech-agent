...
| Related skills | [`excel-author`](/nastech-agent/docs/user-guide/skills/optional/finance/finance-excel-author), [`powerpoint`](/nastech-agent/docs/user-guide/skills/bundled/productivity/productivity-powerpoint) |
