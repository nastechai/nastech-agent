...
| Related skills | [`dcf-model`](/nastech-agent/docs/user-guide/skills/optional/finance/finance-dcf-model), [`comps-analysis`](/nastech-agent/docs/user-guide/skills/optional/finance/finance-comps-analysis), [`lbo-model`](/nastech-agent/docs/user-guide/skills/optional/finance/finance-lbo-model) |
