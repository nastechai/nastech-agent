...
2. **Choose the right context load.** A model-invoked NasTech skill pays for its description every turn. Keep descriptions focused on trigger classes and the skill's distinctive behavior. Put details in the body or linked references.
...
3. **Description too generic or trigger buried past char 57.** The system prompt
   ...
   - Good: `Use when debugging NasTech skill discovery failures.`
   - Bad: `This skill contains detailed guidance for agents working on NasTech skill discovery failures.`
