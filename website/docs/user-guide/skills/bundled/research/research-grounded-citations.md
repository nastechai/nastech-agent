...
| Related skills | [`research-paper-writing`](/nastech-agent/docs/user-guide/skills/bundled/research/research-research-paper-writing), [`arxiv`](/nastech-agent/docs/user-guide/skills/bundled/research/research-arxiv), [`ocr-and-documents`](/nastech-agent/docs/user-guide/skills/bundled/productivity/productivity-ocr-and-documents) |
