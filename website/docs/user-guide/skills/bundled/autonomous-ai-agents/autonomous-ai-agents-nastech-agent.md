---
title: "Nastech Agent — Configure, extend, or contribute to Nastech Agent"
...
If Nastech reports a smaller context window than your local model supports
(e.g., 128k when llama-server has `-c 262144`):

**Check if `model.context_length` is explicitly set.** Nastech uses a
