...
description: "Use when a Nastech Kanban worker wants to run Codex CLI as an isolated implementation lane while Nastech keeps ownership of task lifecycle, reconciliation, tes..."
---
...
| Related skills | [`codex`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`nastech-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-nastech-agent) |
