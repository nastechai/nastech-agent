...
- **You just want to back up a profile on your own machine.** Use [`nastech profile export` / `import`](../reference/profile-commands.md#nastech-profile-export) — that's what those are for.
...
- [`nastech profile export` / `import`](../reference/profile-commands.md#nastech-profile-export) — local backup / restore (not distribution)
