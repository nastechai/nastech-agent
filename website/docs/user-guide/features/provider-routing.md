...
:::tip
Traffic routed through [Nastechai Portal](/integrations/nastechai-portal) still respects per-model routing and priority configs — and Portal subscribers get 10% off token-billed providers.
:::
