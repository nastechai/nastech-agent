...
The self-improving AI agent built by [Nastechai Research](https://nastechai.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
- **Built by model trainers** — Created by [Nastechai Research](https://nastechai.com), the lab behind Nastech, Nomos, and Psyche. Works with [Nastechai Portal](https://portal.nastechai.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nastechai Research](https://nastechai.com) — the lab behind Nastech, Nomos, and Psyche models
