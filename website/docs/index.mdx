...
After installing, run `nastech setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nastechai-portal).
:::
...
- **Built by model trainers** — Created by [Nastechai Research](https://nastechairesearch.com), the lab behind Nastech, Nomos, and Psyche. Works with [Nous Portal](https://portal.nastechairesearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [Nous Portal](/integrations/nastechai-portal) bundles all of them
