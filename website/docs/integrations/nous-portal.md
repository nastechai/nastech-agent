...
The Portal's own [model info page](https://portal.nastechai.com/info) carries the same warning, so this isn't a NasTech-side opinion — it's the official guidance from NasTech Research.
