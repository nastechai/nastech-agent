...
const config: Config = {
  ...
  url: 'https://nastechai.github.io/nastech-agent',
  baseUrl: '/docs/',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://nastechai.github.io/nastech-agent/',
          label: 'Download',
          position: 'left',
        },
        {
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://nastechai.github.io/nastech-agent/' },
