...
[Nous Portal](https://portal.nastechai.com) 是 NasTech Research 的统一订阅网关，也是**运行 NasTech Agent 的推荐方式**。一次 OAuth 登录，即可替代原本需要手动配置的各模型厂商独立账号、API 密钥和计费关系。
...
Portal 自身的[模型信息页](https://portal.nastechai.com/info)也有相同警告，因此这不是 NasTech 侧的主观意见——这是 NasTech Research 的官方指导。
