...
- **由模型训练者构建** — 由 [Nastechai Research](https://nastechairesearch.com) 创建，该实验室是 Nastech、Nomos 和 Psyche 背后的团队。支持 [Nous Portal](https://portal.nastechairesearch.com)、[OpenRouter](https://openrouter.ai)、OpenAI 或任意端点
