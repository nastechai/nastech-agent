...
本指南带你从头到尾完成在 [Nous Portal](https://portal.nastechai.com) 订阅下运行 NasTech Agent 的全过程——从注册账号到验证每个工具的路由是否正确。如果你只想了解 Portal 的概述及订阅内容，请参阅 [Nous Portal 集成页面](/integrations/nous-portal)。本页是操作步骤脚本。
...
Portal 的[信息页面](https://portal.nastechai.com/info)也有此说明——这是 Nous 官方指导，并非仅代表 NasTech 一方的意见。
