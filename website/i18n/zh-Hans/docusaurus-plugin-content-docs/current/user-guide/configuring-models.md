...
[Nastechai Portal](/user-guide/features/tool-gateway) 在单一订阅下提供 300+ 个模型。全新安装后，运行 `nastech setup --portal` 即可登录并一键将 Nastechai 设为提供商。使用 `nastech portal info` 查看当前配置。
:::
