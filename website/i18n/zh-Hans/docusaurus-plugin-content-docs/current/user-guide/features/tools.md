...
付费 [Nastechai Portal](https://portal.nastechai.com) 订阅者可通过 **[Tool Gateway](tool-gateway.md)** 使用网页搜索、图像生成、TTS 和浏览器自动化——无需单独配置 API 密钥。运行 `nastech model` 启用，或通过 `nastech tools` 配置各工具。
:::
