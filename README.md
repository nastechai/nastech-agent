...
<p align="center">
  ...
  <a href="https://nastechairesearch.com"><img src="https://img.shields.io/badge/Built%20by-Nous%20Research-blueviolet?style=for-the-badge" alt="Built by Nastechai Research"></a>
...
Use any model you want — [Nous Portal](https://portal.nastechairesearch.com), OpenRouter, OpenAI, your own endpoint, and [many others](https://nastech-agent.nastechairesearch.com/docs/integrations/providers). Switch with `nastech model` — no code changes, no lock-in.
...
📖 **[Full documentation →](https://nastech-agent.nastechairesearch.com/docs/)**

---

## Skip the API-key collection — Nous Portal

Nastech works with whatever provider you want — that's not changing. But if you'd rather not collect five separate API keys for the model, web search, image generation, TTS, and a cloud browser, **[Nous Portal](https://portal.nastechairesearch.com)** covers all of them under one subscription:
...
That logs you in via OAuth, sets Nous as your provider, and turns on the Tool Gateway. Check what's wired up any time with `nastech portal info`. Full details on the [Tool Gateway docs page](https://nastech-agent.nastechairesearch.com/docs/user-guide/features/tool-gateway).
...
For the full command lists, see the [CLI guide](https://nastech-agent.nastechairesearch.com/docs/user-guide/cli) and the [Messaging Gateway guide](https://nastech-agent.nastechairesearch.com/docs/user-guide/messaging).

---

## Documentation

All documentation lives at **[nastech-agent.nastechairesearch.com/docs](https://nastech-agent.nastechairesearch.com/docs/)**:

| Section                                                                                             | What's Covered                                             |
| --------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| [Quickstart](https://nastech-agent.nastechairesearch.com/docs/getting-started/quickstart)                 | Install → setup → first conversation in 2 minutes          |
| [CLI Usage](https://nastech-agent.nastechairesearch.com/docs/user-guide/cli)                              | Commands, keybindings, personalities, sessions             |
| [Configuration](https://nastech-agent.nastechairesearch.com/docs/user-guide/configuration)                | Config file, providers, models, all options                |
| [Messaging Gateway](https://nastech-agent.nastechairesearch.com/docs/user-guide/messaging)                | Telegram, Discord, Slack, WhatsApp, Signal, Home Assistant |
| [Security](https://nastech-agent.nastechairesearch.com/docs/user-guide/security)                          | Command approval, DM pairing, container isolation          |
| [Tools & Toolsets](https://nastech-agent.nastechairesearch.com/docs/user-guide/features/tools)            | 40+ tools, toolset system, terminal backends               |
| [Skills System](https://nastech-agent.nastechairesearch.com/docs/user-guide/features/skills)              | Procedural memory, Skills Hub, creating skills             |
| [Memory](https://nastech-agent.nastechairesearch.com/docs/user-guide/features/memory)                     | Persistent memory, user profiles, best practices           |
| [MCP Integration](https://nastech-agent.nastechairesearch.com/docs/user-guide/features/mcp)               | Connect any MCP server for extended capabilities           |
| [Cron Scheduling](https://nastech-agent.nastechairesearch.com/docs/user-guide/features/cron)              | Scheduled tasks with platform delivery                     |
| [Context Files](https://nastech-agent.nastechairesearch.com/docs/user-guide/features/context-files)       | Project context that shapes every conversation             |
| [Architecture](https://nastech-agent.nastechairesearch.com/docs/developer-guide/architecture)             | Project structure, agent loop, key classes                 |
| [Contributing](https://nastech-agent.nastechairesearch.com/docs/developer-guide/contributing)             | Development setup, PR process, code style                  |
| [CLI Reference](https://nastech-agent.nastechairesearch.com/docs/reference/cli-commands)                  | All commands and flags                                     |
| [Environment Variables](https://nastech-agent.nastechairesearch.com/docs/reference/environment-variables) | Complete env var reference                                 |
...
We welcome contributions! See the [Contributing Guide](https://nastech-agent.nastechairesearch.com/docs/developer-guide/contributing) for development setup, code style, and PR process.
