...
<p align="center">
  ...
  <a href="https://nastechai.com"><img src="https://img.shields.io/badge/Built%20by-Nous%20Research-blueviolet?style=for-the-badge" alt="Built by NasTech Research"></a>
  <a href="README.zh-CN.md"><img src="https://img.shields.io/badge/Lang-中文-red?style=for-the-badge" alt="中文"></a>
  <a href="README.ur-pk.md"><img src="https://img.shields.io/badge/Lang-اردو-green?style=for-the-badge" alt="اردو"></a>
  <a href="README.es.md"><img src="https://img.shields.io/badge/Lang-Español-orange?style=for-the-badge" alt="Español"></a>
</p>

**The self-improving AI agent built by [NasTech Research](https://nastechai.com).** It's the only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, searches its own past conversations, and builds a deepening model of who you are across sessions. Run it on a $5 VPS, a GPU cluster, or serverless infrastructure that costs nearly nothing when idle. It's not tied to your laptop — talk to it from Telegram while it works on a cloud VM.

Use any model you want — [Nous Portal](https://portal.nastechai.com), OpenRouter, OpenAI, your own endpoint, and [many others](https://NasTech-Agent.nastechai.com/docs/integrations/providers). Switch with `nastech model` — no code changes, no lock-in.
...
> **Android / Termux:** The tested manual path is documented in the [Termux guide](https://NasTech-Agent.nastechai.com/docs/getting-started/termux). On Termux, NasTech installs a curated `.[termux]` extra because the full `.[all]` extra currently pulls Android-incompatible voice dependencies.
>
...
📖 **[Full documentation →](https://NasTech-Agent.nastechai.com/docs/)**

---

## Skip the API-key collection — Nous Portal

NasTech works with whatever provider you want — that's not changing. But if you'd rather not collect five separate API keys for the model, web search, image generation, TTS, and a cloud browser, **[Nous Portal](https://portal.nastechai.com)** covers all of them under one subscription:
...
That logs you in via OAuth, sets Nous as your provider, and turns on the Tool Gateway. Check what's wired up any time with `nastech portal info`. Full details on the [Tool Gateway docs page](https://NasTech-Agent.nastechai.com/docs/user-guide/features/tool-gateway).
...
For the full command lists, see the [CLI guide](https://NasTech-Agent.nastechai.com/docs/user-guide/cli) and the [Messaging Gateway guide](https://NasTech-Agent.nastechai.com/docs/user-guide/messaging).

---

## Documentation

All documentation lives at **[NasTech-Agent.nastechai.com/docs](https://NasTech-Agent.nastechai.com/docs/)**:

| Section                                                                                             | What's Covered                                             |
| --------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| [Quickstart](https://NasTech-Agent.nastechai.com/docs/getting-started/quickstart)                 | Install → setup → first conversation in 2 minutes          |
| [CLI Usage](https://NasTech-Agent.nastechai.com/docs/user-guide/cli)                              | Commands, keybindings, personalities, sessions             |
| [Configuration](https://NasTech-Agent.nastechai.com/docs/user-guide/configuration)                | Config file, providers, models, all options                |
| [Messaging Gateway](https://NasTech-Agent.nastechai.com/docs/user-guide/messaging)                | Telegram, Discord, Slack, WhatsApp, Signal, Home Assistant |
| [Security](https://NasTech-Agent.nastechai.com/docs/user-guide/security)                          | Command approval, DM pairing, container isolation          |
| [Tools & Toolsets](https://NasTech-Agent.nastechai.com/docs/user-guide/features/tools)            | 40+ tools, toolset system, terminal backends               |
| [Skills System](https://NasTech-Agent.nastechai.com/docs/user-guide/features/skills)              | Procedural memory, Skills Hub, creating skills             |
| [Memory](https://NasTech-Agent.nastechai.com/docs/user-guide/features/memory)                     | Persistent memory, user profiles, best practices           |
| [MCP Integration](https://NasTech-Agent.nastechai.com/docs/user-guide/features/mcp)               | Connect any MCP server for extended capabilities           |
| [Cron Scheduling](https://NasTech-Agent.nastechai.com/docs/user-guide/features/cron)              | Scheduled tasks with platform delivery                     |
| [Context Files](https://NasTech-Agent.nastechai.com/docs/user-guide/features/context-files)       | Project context that shapes every conversation             |
| [Architecture](https://NasTech-Agent.nastechai.com/docs/developer-guide/architecture)             | Project structure, agent loop, key classes                 |
| [Contributing](https://NasTech-Agent.nastechai.com/docs/developer-guide/contributing)             | Development setup, PR process, code style                  |
| [CLI Reference](https://NasTech-Agent.nastechai.com/docs/reference/cli-commands)                  | All commands and flags                                     |
| [Environment Variables](https://NasTech-Agent.nastechai.com/docs/reference/environment-variables) | Complete env var reference                                 |
...
We welcome contributions! See the [Contributing Guide](https://NasTech-Agent.nastechai.com/docs/developer-guide/contributing) for development setup, code style, and PR process.
...
Built by [NasTech Research](https://nastechai.com).
