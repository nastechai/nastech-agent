...
- Use the **semantic text tokens** from `@nastechai-research/ui`'s `globals.css`:
...
- The dashboard preserves the Nastechai brand uppercase aesthetic, but it is **opt-in per element, not global**.
