...
### `GET /api/plugins/nastech-achievements/achievements`
...
### `POST /api/plugins/nastech-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/plugins/nastech-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/plugins/nastech-achievements/overview`
...
- Persist plugin data under:
  - `~/.nastech/plugins/nastech-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.nastech/plugins/nastech-achievements/scan_checkpoint.json`
...
- `~/.nastech/plugins/nastech-achievements/`
