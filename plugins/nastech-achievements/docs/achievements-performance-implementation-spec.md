...
- persisted runtime files:
  - `~/.nastech/plugins/nastech-achievements/state.json` (existing unlock state)
  - `~/.nastech/plugins/nastech-achievements/scan_snapshot.json` (new)
  - `~/.nastech/plugins/nastech-achievements/scan_checkpoint.json` (new)
