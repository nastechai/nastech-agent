# Nastech Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.nastech/plugins/nastech-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.nastech/plugins/nastech-achievements/scan_checkpoint.json`.
