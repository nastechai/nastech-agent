...
Nastech feature-detects the dynamic-plugin activation API available in NeMo Relay
0.6 and later. Configure native or worker plugins with Nastech-owned
...
activation API, Nastech logs an actionable warning and continues with the
