...
from agent.portal_tags import get_conversation_context, nastechai_portal_tags
...
class NasTechaiProfile(ProviderProfile):
    ...
    def build_extra_body(
        ...
        body: dict[str, Any] = {"tags": nastechai_portal_tags(session_id=session_id)}
        ...
        #
        # Resolve it exactly like ``nastechai_portal_tags`` resolves the
...
nastechai = NasTechaiProfile(
    name="nastechai",
    aliases=("nastechai-portal", "nousresearch"),
