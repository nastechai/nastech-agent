...
# trigger its own recovery path. Refs: NasTech Research/NasTech-Agent#59614
...
# _UPDATER_STOP_TIMEOUT. Refs: NasTech Research/NasTech-Agent#66377
_DRAIN_TIMEOUT = 15.0
        ...
        try:
            if app and app.updater and app.updater.running:
                try:
                    ...
                    # Refs: NasTech Research/NasTech-Agent#58270
