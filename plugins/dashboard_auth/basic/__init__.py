...
into the same ``DashboardAuthProvider`` framework as the Nastechai OAuth
...
mirroring the Nastechai provider's precedence convention:
...
Skip reasons:
  Like the Nastechai provider, this exposes a module-level ``LAST_SKIP_REASON``
