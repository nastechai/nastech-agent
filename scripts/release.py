...
LEGACY_AUTHOR_MAP = {
    ...
    "moonsong@nastechai.local": "Tranquil-Flow",  # PR #52623 salvage (auxiliary Anthropic base_url host validation; #52608)
    ...
    "nastech@nastechai.com": "NasTech Research",
    ...
    "annguyen@nastechai.com": "annguyenNous",  # PR #52844 co-author
