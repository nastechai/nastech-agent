...
DEFAULT_DATASETS = [
    "NasTech Research/swe-terminus-agent-glm-kimi-minimax",
    "NasTech Research/NasTech-Agent-megascience-sft1",
    "NasTech Research/NasTech-Agent-Thinking-GLM-4.7-SFT2",
    "NasTech Research/NasTech-Agent-Thinking-GLM-4.7-SFT1",
    "NasTech Research/terminal-tasks-glm-NasTech-Agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "NasTech Research/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload NasTech Research/{output_name} {final_output}")
