...
DEFAULT_DATASETS = [
    ...
    "NastechaiResearch/Nastech-Agent-Thinking-GLM-4.7-SFT2",
    "NastechaiResearch/Nastech-Agent-Thinking-GLM-4.7-SFT1",
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "NastechaiResearch/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload NastechaiResearch/{output_name} {final_output}")
