...
class MCPServerTask:
                ...
                if _MCP_NOTIFICATION_TYPES and isinstance(message, ServerNotification):
                    match message.root:
                        case ToolListChangedNotification():
                            ...
                            # request. Refreshing synchronastechaily inside the SDK
    ...
    async def _refresh_tools(self):
        ...
        After the initial ``await`` (list_tools), all mutations are synchronastechai
...
# can be cleaned up asynchronastechaily by _kill_orphaned_mcp_children().
...
def _load_mcp_config() -> Dict[str, dict]:
    ...
    try:
        ...
        # Safe mode (--safe-mode / NASTECH_SAFE_MODE=1): troubleshooting run
