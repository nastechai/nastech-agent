...
def _resolve_mcp_invocation(
    ...
    *,
    ...
    Surface 8 of nastechairesearch/nastech-agent#47072: instead of hardcoding
...
def _parse_elements_from_structured(raw_elements: List[Dict[str, Any]]) -> List[UIElement]:
    """Surface 2 of nastechairesearch/nastech-agent#47072: read the canonical
...
class _CuaDriverSession:
    ...
    def __init__(self, bridge: _AsyncBridge) -> None:
        ...
        self._started = False
        # Surface 4 of nastechairesearch/nastech-agent#47072: per-tool
    ...
    async def _lifecycle_coro(self) -> None:
        ...
        try:
            ...
            # failures to the synchronastechai world.
            self._setup_error = e
            self._ready_event.set()
            raise
        finally:
...
def _extract_tool_result(mcp_result: Any) -> Dict[str, Any]:
    ...
    nastechairesearch/nastech-agent#47072). Each entry corresponds index-for-index
...
class CuaDriverBackend(ComputerUseBackend):
    ...
    def __init__(self) -> None:
        ...
        # Surface 6 of nastechairesearch/nastech-agent#47072: per-snapshot
    ...
    def capture(self, mode: str = "som", app: Optional[str] = None) -> CaptureResult:
        ...
        # Surface 3 of nastechairesearch/nastech-agent#47072: read the canonical
        ...
        if mode == "vision":
            ...
            # Surface 2 of nastechairesearch/nastech-agent#47072: prefer the
    ...
    def click(
        ...
        *,
        ...
        # nastechairesearch/nastech-agent#47072). cua-driver-rs gained an explicit
