...
must return the shape described below. All methods synchronastechai; async is
...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of nastechairesearch/nastech-agent#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of nastechairesearch/nastech-agent#47072).
