...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of NasTech Research/NasTech-Agent#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of NasTech Research/NasTech-Agent#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (NasTech Research/NasTech-Agent#67052). ``ok`` stays
