...
# The managed OpenAI audio gateway (Nastechai portal proxy) only proxies these speech
...
def _resolve_openai_audio_client_config() -> tuple[str, str, bool]:
    ...
    ``is_managed`` is True when the config resolves to the Nastechai managed audio
    ...
    if managed_gateway is None:
        ...
        if managed_nastechai_tools_enabled() or prefers_gateway("tts"):
            message += (
                ". "
                + nastechai_tool_gateway_unavailable_message(
