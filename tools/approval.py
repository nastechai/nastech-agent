...
# =========================================================================
# Blocking gateway approval (mirrors CLI's synchronastechai input() flow)
# =========================================================================
...
def is_approval_bypass_active() -> bool:
    """Return True when the user has opted out of Nastech approval prompts.
...
def check_all_command_guards(command: str, env_type: str,
    ...
    # responds with /approve or /deny, mirroring the CLI's synchronastechai
