...
supports multiple backends — **Browser Use** (cloud, default for NasTechai
...
def _get_cloud_provider() -> Optional[CloudBrowserProvider]:
    ...
    fallback. If unset, fall back to Browser Use (managed NasTechai gateway or
    ...
    if resolved is None:
        # Auto-detect path: Browser Use first (managed NasTechai gateway or
        ...
        try:
            ...
            if _requires_real_termux_browser_install(browser_cmd):
                ...
                if _running_in_docker():
                    ...
                    print("       docker pull ghcr.io/nousresearch/nastech-agent:latest")
                else:
