...
def _get_max_async_children() -> int:
    ...
    synchronastechai batch's parallelism and how many background delegation units
    ...
    caller falls back to running the work synchronastechaily.
...
def delegate_task(
    ...
    def _execute_and_aggregate() -> dict:
        ...
        dict. Used by BOTH the synchronastechai path and the background runner. In
    ...
    if background:
        ...
        # conversation (issue #10760). Fall back to SYNCHRONASTECHAI execution: the
        ...
        if not _async_ok:
            logger.info(
                ...
                "(stateless HTTP API); running the batch synchronastechaily instead."
            )
            ...
            if isinstance(_sync_result, dict):
                _sync_result["note"] = (
                    ...
                    "after the turn ends), so the subagent(s) ran SYNCHRONASTECHAILY and "
        ...
        logger.info(
            ...
            "batch synchronastechaily instead.",
        ...
        if isinstance(_cap_result, dict):
            _cap_result["note"] = (
                ...
                "SYNCHRONASTECHAILY and the result is included above. Raise "
...
def _resolve_delegation_credentials(cfg: dict, parent_agent) -> dict:
    ...
    try:
        ...
        raise ValueError(
            ...
            f"Available providers: openrouter, nastechai, zai, kimi-coding, minimax."
        ) from exc
...
def _model_background_value(args: dict, parent_agent=None) -> bool:
    ...
    keep the historical synchronastechai default.
    """
